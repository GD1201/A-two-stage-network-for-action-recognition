...
class MaskedAutoencoderViT(nn.Module):
    ...
    """
    def __init__(self,frame_nums=120,skeleton_nums=18,patch_size=20, in_chans=3,
                 embed_dim=256, depth=8, num_heads=4,
                 ...
                 use_fm=[-1], use_input=True, self_attn=False,):
        super().__init__()
    ...
    def skeleton_ids(self,data_skeleton,dynamic_ratio,static_ratio,L):
        ...
        assert (C == 3)
        ### 计算连续帧之间的坐标
        xy1 = data_skeleton[:,0:2, 0:T - 1, :, :][...,0]
        xy2 =data_skeleton[:,0:2, 1:T, :, :][...,0]
        ...
        ids=self.random_static_dynamic(d_sorted,static_ratio,dynamic_ratio,L,B)
        return ids
...
def mae_vit_base_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
          frame_nums=120,skeleton_nums=18,patch_size=20, embed_dim=512, depth=8, num_heads=8,
